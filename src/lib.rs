...
use web_sys::{WebGlProgram, MouseEvent, HtmlInputElement, WebGlRenderingContext, WebGlShader};
...
pub fn start() -> Result<(), JsValue> {
    ...
    canvas.set_width(gpu::gpu::WIDTH as u32);
    canvas.set_height(gpu::gpu::HEIGHT as u32);
